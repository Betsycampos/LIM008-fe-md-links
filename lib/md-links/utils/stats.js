...
console.log(extractLinks(fileReturnMd("C:\\Users\\Laboratoria\\Documents\\Markdown-Links\\LIM008-fe-md-links\\prueba"))); // export const validateLinks = (myRoute) => { 
//     const arrObjLinks = extractLinks(myRoute);
